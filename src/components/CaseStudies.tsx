...
const CaseStudy: React.FC<{ id: number; title: string; description: string; result: string; image: string }> = ({ id, title, description, result, image }) => (
  <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg">
    ...
    <div className="p-6">
      ...
      <Link to={`/casos-de-exito/${id}`} className="inline-block border border-red-500 text-red-500 px-4 py-2 rounded hover:bg-red-500 hover:text-white transition-colors">
        Ver Detalles
      </Link>
    </div>
  </div>
